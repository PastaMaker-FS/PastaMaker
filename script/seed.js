...
const products = [
  ...
  {
    name: `Lasagna`,
    description: `Create original Lasagna casseroles by using chopped vegetables, cheeses and any kind of sauce. You can also assemble your casserole and freeze it for a later meal.`,
    price: 1099,
    stock: 800,
    imgUrl: 'https://i.imgur.com/fNPEbHb.jpg'
  }
]

const ProductTypes = [{name: `long`}, {name: `short`}, {name: `stuffed`}]
